...
public:
    ...
    void setupUi(QMainWindow *plantzombie)
    {
        ...
        graphicsView->setGeometry(QRect(-10, 150, 1100, 530));
        ...
        label->setGeometry(QRect(1100, 150, 63, 41));
        ...
        label_2->setGeometry(QRect(1190, 160, 71, 41));
        QFont font;
        ...
        brainlabel->setGeometry(QRect(1100, 580, 63, 31));
        ...
        Brainlabel->setObjectName("Brainlabel");
        Brainlabel->setEnabled(true);
        Brainlabel->setGeometry(QRect(1200, 570, 131, 41));
        sizePolicy.setHeightForWidth(Brainlabel->sizePolicy().hasHeightForWidth());
        Brainlabel->setSizePolicy(sizePolicy);
        QFont font1;
